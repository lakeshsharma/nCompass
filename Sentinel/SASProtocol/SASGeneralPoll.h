...
// See LoadGPEDescriptions() for description of each item
// If adding or removing enum item be sure to modify LoadGPEDescriptions() accordingly.
typedef enum
{
	...
	GPE_TICKET_CASHOUT		= 0x3D,		//{ticket cashout}
	...
	GPE_COIN_IN_LOCKOUT_ERROR	= 0x79,
	GPE_SOFT_METERS_RESET_TO_ZERO = 0x7a,
	GPE_BILL_VALIDATOR_RESET	= 0x7b,
	GPE_LEGACY_BONUS_JACKPOT	= 0x7c,
	...
	GPE_EGM_OUT_OF_SERVICE	= 0x86,
	GPE_PLAYER_DRAW_REQUEST = 0x87,
	GPE_REEL_STOPPED		= 0x88,
	GPE_COINCREDIT_WAGERED	= 0x89,
	GPE_GAME_RECALL_DISPLAY = 0x8a,
	GPE_CARD_HELDNOTHELD	= 0x8b,
	GPE_GAME_SELECTED		= 0x8c,
	GPE_COMPONENTLIST_CHANGED = 0x8e,
	GPE_AUTHENTICATED		= 0x8f,
...
{
public:
	static const BYTE POLL_VALUE = (BYTE)-1;
...
public:
	...
	/// <summary>
	/// Returns true because this instance sends general polls.
	/// </summary>
