...
CPollerGenericTransactionMessage::CPollerGenericTransactionMessage(CMeters *meters,
	byte transCode,
	DWORD uniqueID,
	const byte * cardID,
...
void CPollerGenericTransactionMessage::SetStatus(DWORD status)
{
	m_status = status;
}

DWORD CPollerGenericTransactionMessage::GetStatus()
{
	return m_status;
}

byte * CPollerGenericTransactionMessage::GetReadWriteBuffer(DWORD &bufferSize)
{
	bufferSize = m_bufferSize;
	return m_lpBuffer;
}

void CPollerGenericTransactionMessage::SetReadWriteBuffer()
{
	m_bBufferIsSet = true;
