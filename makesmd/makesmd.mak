...
ifeq "$(CFG)" "Debug"
OUTDIR=Debug
OUTFILE=$(OUTDIR)/makesmd
CFG_INC=
CFG_LIB=
CFG_OBJ=
COMMON_OBJ=$(OUTDIR)/FilePacker.o $(OUTDIR)/makesmd.o 
OBJ=$(COMMON_OBJ) $(CFG_OBJ)
ALL_OBJ=$(OUTDIR)/FilePacker.o $(OUTDIR)/makesmd.o 

COMPILE=g++ -c   -g -std=c++11 -o "$(OUTDIR)/$(*F).o" $(CFG_INC) $<
LINK=g++  -g -std=c++11 -o "$(OUTFILE)" $(ALL_OBJ)
...
COMPILE=g++ -c   -O2 -std=c++11 -o "$(OUTDIR)/$(*F).o" $(CFG_INC) $<
LINK=g++  -O2 -std=c++11 -o "$(OUTFILE)" $(ALL_OBJ)
